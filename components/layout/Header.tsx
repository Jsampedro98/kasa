          ...
          <div className="flex gap-4 items-center border-l border-gray-200 pl-6 h-5">
            {mounted && isAuthenticated ? (
              <>
                ...
                <button aria-label="Messages" className="hover:scale-110 transition text-noir hover:text-main-red">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
          ...
          <nav className="flex flex-col gap-4 text-lg text-noir border-t border-gray-100 pt-4">
              ...
              {mounted && isAuthenticated ? (
                <>
                  ...
                  <div className="py-2 font-bold text-main-red">Bonjour, {user?.name}</div>
